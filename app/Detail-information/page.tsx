...
<div>
    ...
    <Card className="py-4 border-none shadow-none">
      <CardHeader className="mt-4 mb-4 pb-0 pt-2 px-4 flex-col items-center">
        <h4 className="font-bold text-3xl">Réunion importante</h4>
        <small className="text-default-500 font-bold">par André Leroy</small>
      </CardHeader>
    ...
    <div className="mt-8 mb-10 mx-8 text-justify">
        <h4 className="font-bold text-center text-xl mb-6">Vendredi réunion dans la salle 13</h4>
